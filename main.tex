...
\usepackage{lipsum} % Paquete para generación de texto
\input{config.tex}
...
\input{sections/2_tecnicas.tex}
\input{sections/3_pre.tex}
\input{sections/4_cus.tex}
\input{sections/5_desafios.tex}
\input{sections/6_tools.tex}
